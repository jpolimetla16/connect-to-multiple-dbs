...
@EnableJpaRepositories(basePackages = {"com.jp.customers"},
	...
	transactionManagerRef = "customersPlatoformTransactionManager")
public class CustomersDBConfig {
	...
	@Bean
	@Primary
	public PlatformTransactionManager customersPlatoformTransactionManager() {
		JpaTransactionManager jpaTransactionManager = new JpaTransactionManager();
		jpaTransactionManager.setEntityManagerFactory(customersLocalSessionFactoryBean().getObject());
